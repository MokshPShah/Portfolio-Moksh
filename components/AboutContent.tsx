    ...
    return (
        <div className="min-h-screen bg-black/96 antialiased bg-grid-white/[0.02] relative">
            ...
            <div className="max-w-6xl mx-auto px-6 py-24 relative z-10">
                ...
                {/* Final CTA */}
                <div className="mt-32 mb-20 text-center bg-slate-800/25 shadow py-15 rounded-lg">
                    ...
                    <Link href="/contact" className="inline-flex animate-shimmer items-center justify-center">
                        <HoverBorderGradient
